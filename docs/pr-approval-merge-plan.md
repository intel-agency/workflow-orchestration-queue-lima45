...
**Locations to update:**
- The orchestrator prompt template in `workflow-orchestration-queue-lima45` (e.g., `scripts/prompt.ps1`, `orchestrator-supervisor.md`, or the assembled prompt).
...
| Orchestrator prompt (TBD exact file) | workflow-orchestration-queue-lima45 | Define 4-step loop |
